import { Box, Button, FormControl, Input, ListSubheader, MenuItem, NativeSelect, Select, TextField, Typography, createTheme } from "@mui/material";
...
const AskItem = () => {
    ...
    const getUser = async () => {
        return await axios.get(`https://localhost:7106/api/User/${sessionStorage.getItem('userId')}`)
    }
    ...
    function handleSave(e) {
        ...
        if (!isOk) {
            ...
            setCurrItem({
                ...
                FileImage: file ? file.get('Image') : null,
                AskId: +sessionStorage.getItem('userId'),
    ...
    return (<>
        ...
        <Typography variant="h2" gutterBottom>ask item</Typography>
        ...
        <Box component="form" onSubmit={formik.handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <FormControl sx={{ m: 1, minWidth: 120 }}>
                ...
                <Select native defaultValue="" id="grouped-native-select" label="Sub Category" onChange={changeSubCategory}>
